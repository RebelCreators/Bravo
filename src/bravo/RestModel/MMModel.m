...
+ (NSValueTransformer *)JSONTransformerForKey:(NSString *)key {
    ...
    } else if ([typeAttribute hasPrefix:@"T@"] && [[self classFromPropertyType:typeAttribute] isSubclassOfClass:RCEnumerable.class]) {
        return [MMValueTransformer enumTransformerForContainerClass:[self enumAttributeTypes][key]];
...
+ (NSValueTransformer *)transformerForClass:(Class)clazz
    ...
    if ([clazz isSubclassOfClass:[NSDate class]]) {
        ...
        RCServiceIOType type = [MMValueTransformer serviceTypeForClass:[self listAttributeTypes][key]];
        ...
        RCServiceIOType type = [MMValueTransformer serviceTypeForClass:[self mapAttributeTypes][key]];
